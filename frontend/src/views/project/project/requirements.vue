<template>
  <el-card class="r-cards">
    ...
    <div class="search"><el-form :inline="true" :model="Params" class="sF"><el-form-item label="requirements">
          ...
          <el-select v-model="Params.priority" placeholder="select priority" clearable style="width: 200px"><el-option label="high" value="1" />
    ...
    <div class="rList">
      ...
      >
        <el-table-column label="ID" align="center">
          <template #default="{ row }"><el-link type="primary" @click="clickV(row)">{{ row.requirementId }}</el-link>
          </template>
        </el-table-column>
