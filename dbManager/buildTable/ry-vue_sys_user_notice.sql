...
CREATE TABLE `sys_user_notice` (
  ...
  KEY `user_id` (`user_id`),
  CONSTRAINT `sys_user_notice_ibfk_1` FOREIGN KEY (`notice_id`) REFERENCES `sys_notice` (`notice_id`) ON DELETE CASCADE,
  CONSTRAINT `sys_user_notice_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `sys_user` (`user_id`) ON DELETE CASCADE
